export const scripts = [
            {
                        ...
                        "iconPath": "<polygon points=\"12 2 22 20 2 20\"></polygon><circle cx=\"12\" cy=\"14\" r=\"2\"></circle>",
                        "features": [
            ...
            },
            {
                        ...
                        "iconPath": "<rect height=\"18\" rx=\"2\" width=\"18\" x=\"3\" y=\"3\"></rect><path d=\"M9 3v18M15 3v18M3 9h18M3 15h18\" stroke-dasharray=\"2 2\"></path>",
                        "features": [
            ...
            },
            {
                        ...
                        "desc": "A supporter racing helper that keeps Torn custom-race lists focused around selected criteria, licensing and compact join controls.",
                        "version": "v2.5.2",
                        "versionPrefix": "VER",
                        ...
                        "iconPath": "<path d=\"M4 6h16M4 12h16m-7 6h7\" stroke-linecap=\"square\"></path><circle cx=\"7\" cy=\"18\" r=\"2\"></circle>",
                        "features": [
            ...
            },
            {
                        ...
                        "tier": "supporter",
                        "title": "Tornfolio",
                        "desc": "A Torn property, lease and ROI manager for owners and renters, evolving from the former Landlord Tenant Ledger.",
                        ...
                        "disabledActions": [
                                    "Public install not released"
                        ],
                        "note": "Tornfolio is currently a private preview. The project page is public, but there is no public install link yet."
            },
            {
                        "id": "modulHubControl",
                        "tier": "free",
                        "title": "MoDuL Hub Control Room",
                        "desc": "The shared theme source of truth for MoDuL Torn scripts, including palettes, typography, spacing, radius and the canonical mh-* contract.",
                        "version": "v0.2.10",
                        "versionPrefix": "VER",
            ...
            },
            {
                        ...
                        "tier": "free",
                        "title": "Race Tracker",
                        "desc": "A structured Google Sheets racing toolkit with public workbook copy flow, documentation, screenshots and analytics views.",
                        "version": "IN DEVELOPMENT",
                        "versionPrefix": "STATUS",
                        "category": "Racing analytics",
                        "projectType": "Google Sheets toolkit",
                        "releaseState": "Sheet live; toolkit in development",
                        "updated": "No release date published",
                        "badge": "dev",
                        "badgeText": "DEV",
                        ...
                        "actions": [
                                    ...
                                    },
                                    {
                                                ...
                                                "href": "https://docs.google.com/spreadsheets/d/1ANiFcBuMgpXYXGhycc4HaFHfUZsLjoKsLyRB5llFIz8/copy",
                                                "icon": "table_view",
                                                "primary": true
                                    }
                        ],
                        "disabledActions": [
                                    "Toolkit still in development"
                        ]
            },
            {
                        "id": "eggsTerminator",
                        ...
                        "desc": "A state-aware Easter event helper combining page navigation, egg visibility tools and separate found/collected tracking.",
                        "version": "v2.5.12",
                        "versionPrefix": "VER",
            ...
            },
            {
                        ...
                        "desc": "A PDA-safe userscript that synchronises Torn racing visuals, banners and race details with the selected race-class theme.",
                        "version": "v1.2.6",
                        "versionPrefix": "VER",
            ...
            },
            {
                        ...
                        "desc": "A lightweight Torn userscript that restores original car naming across racing, markets, bazaars, logs and docks views.",
                        "version": "v1.3.2",
                        "versionPrefix": "VER",
            ...
            },
            {
                        ...
                        "tier": "free",
                        "title": "Stock-X",
                        "desc": "A stock-focused Torn helper in active development, with vault, ROI and trade-assistant documentation already published.",
                        "version": "v1.0.0",
                        "versionPrefix": "VER",
                        ...
                        "disabledActions": [
                                    "Public download pending review"
                        ],
                        "note": "Stock-X documentation is live, but the current hub intentionally does not expose a public install route while the workflow remains in development."
            },
            {
                        "id": "smuggler",
                        "tier": "free",
                        "title": "Smuggler",
                        "desc": "A Torn and TornPDA travel helper for repeat abroad runs, destination planning, item workflows and flight timing.",
                        "version": "v3.0.6",
                        "versionPrefix": "VER",
            ...
            },
            {
                        ...
                        "desc": "A focused Torn bootlegging helper for copying DVD stock and queue totals and finding the genre with the lowest combined workload.",
                        "version": "v0.3.4",
                        "versionPrefix": "VER",
                        ...
                        "badge": "free",
                        "badgeText": "FREE",
                        "iconPath": "<rect x=\"3\" y=\"3\" width=\"18\" height=\"18\" rx=\"2\"></rect><circle cx=\"12\" cy=\"12\" r=\"3\"></circle><path d=\"M7 7h.01M17 7h.01M7 17h.01M17 17h.01\"></path>",
                        "features": [
                        ...
                        "actions": [
                                    {
                                                ...
                                                "href": "https://greasyfork.org/en/scripts/579366-torn-bootlegging-copy-dvds-stock-queue-helper",
                                                "icon": "download",
                                                "primary": true
                                    }
                        ]
            },
            {
                        ...
                        "tier": "web tools",
                        "title": "JobCentre+",
                        "desc": "A privacy-first Torn employment marketplace with verified profiles, vacancies, applications, dashboards and the JC+ Live Notifier companion userscript.",
                        "version": "v2.1.3",
                        ...
                        "iconPath": "<path d=\"M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z\"></path>",
                        "features": [
                        ...
                        "actions": [
                                    ...
                                    {
                                                "label": "Install Notifier v2.1.3",
                                                "href": "https://pp-api.sokin.xyz/jobcentreplus/api/notifications/install/jobcentre-plus-notifier.user.js",
            ...
            },
            {
                        ...
                        "desc": "The hosted companion dashboard for authenticated Pythagoras CIS workspaces, company data, analytics and reports.",
            ...
            },
            {
                        ...
                        "tier": "archive",
                        "title": "Lap Recorder",
                        "desc": "The archived lap-capture project that helped shape the next generation of MoDuL racing tools.",
                        "version": "ARCHIVED",
                        "versionPrefix": "STATUS",
                        ...
                        "iconPath": "<rect x=\"3\" y=\"3\" width=\"18\" height=\"18\" rx=\"2\"></rect><path d=\"M8 3v18M16 3v18M3 8h18M3 16h18\"></path>",
                        "features": [
                        ...
                        "note": "Lap Recorder is no longer maintained or promoted. Its archive remains online for screenshots, history and the development lessons carried into Pit Guru."
            }
];
        ...
        export const scriptReleases = [
            ...
            },
            {
                ...
                date: '2026-08-17',
                type: 'HOTFIX',
                summary: 'Restored reliable server transport, direct #job links, stable panel scrolling and quieter diagnostics.',
                href: 'https://pp-api.sokin.xyz/jobcentreplus/'
            },
            {
                scriptId: 'cracked',
                ...
                date: '2026-08-13',
                type: 'RELEASE',
                summary: 'Added calibrated probability estimates, an unknown-word fallback model and self-measuring telemetry.',
                href: 'https://greasyfork.org/en/scripts/589397-cracked'
            },
            {
                scriptId: 'pitGuru',
                ...
                date: '2026-07-30',
                type: 'RELEASE',
                summary: 'Repaired prediction and history car images and linked Records race IDs directly to replay.',
                href: 'pit-guru/'
            },
            {
                ...
                date: '2026-07-28',
                type: 'RELEASE',
                summary: 'Added a draggable saved launcher and dedicated selected-control colours to the shared theme contract.',
                href: 'global-theme/'
            },
            {
                scriptId: 'pythagoras',
                ...
                date: '2026-07-26',
                type: 'RELEASE',
                summary: 'Reconciled Company News with exact training-action records for correct grouped and raw totals.',
                href: 'pythagoras-project-cis/'
            },
            {
                ...
                date: '2026-07-14',
                type: 'RELEASE',
                summary: 'Made compact join controls own their navigation so refreshed Torn handlers cannot swallow clicks.',
                href: 'custom-race-filter/'
            },
            {
                scriptId: 'smuggler',
                ...
                date: '2026-07-08',
                type: 'RELEASE',
                summary: 'Kept active flight sessions stable across page changes and preserved route progress without repeated fetches.',
                href: 'smuggler/'
            },
            {
                ...
                date: '2026-06-06',
                type: 'RELEASE',
                summary: 'Published the current cross-page naming build for racing, markets, bazaars, logs and docks.',
                href: 'restore-og-names/'
            },
            {
                ...
                date: '2026-04-28',
                type: 'RELEASE',
                summary: 'Stabilised state-aware navigation, manual log sync and separate found and collected counters.',
                href: 'eggsterminator/'
            },
            {
                ...
                date: '2026-04-20',
                type: 'RELEASE',
                summary: 'Added lock and sizing controls while retaining the permanent PDA-safe racing information bar.',
                href: 'race-theme-changer/'
            }
        ];

        export { moduleFaqs } from './module-faqs.js?v=20260825.5';
